        ...
        <header class="site-header">
                        ...
                        <div class="col-3 col-lg-9 flex justify-content-end align-content-center">
                            <nav class="site-navigation flex justify-content-end align-items-center">
                                <ul class="flex flex-column flex-lg-row justify-content-lg-end align-content-center">
                                    ...
                                    <li><a href="stufees.jsp">Salary</a></li>
                                    <li><a href="stumarksview.jsp">View Marks</a></li>
                                </ul>
         ...
         <div >
            ...
            <div class="container">
             ...
             %>
             <form method="post" action="stumarksadd.jsp">
                 <center> <table>
                     <tr>
                         <td>Select name</td>
                         ...
                         <td><select name="stuid">
                            ...
                            <tr>
                                <td>Enter Test Subject:-</td>
                                <td><input class =form-control" type="text" name="sub"></td>
                            </tr>
                            <tr>
                                <td>Enter Marks:-</td>

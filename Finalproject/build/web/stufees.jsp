...
<script>
    ...
    {
        var a=document.getElementById("tfe").value;
        var b=fees.value;
        var c=a-b;
        document.getElementById("pefe").value=c;
        ...
        <header class="site-header">
                        ...
                        <div class="col-3 col-lg-9 flex justify-content-end align-content-center">
                            <nav class="site-navigation flex justify-content-end align-items-center">
                                <ul class="flex flex-column flex-lg-row justify-content-lg-end align-content-center">
                                    ...
                                    <li><a href="stufeesview.jsp">Fees Details</a></li>
         ...
         <div >
            ...
            <div class="container">
             ...
             %>
             <form method="post" action="stufeesadd.jsp">
                 <center> <table>
                     <tr>
                         <td>Select name</td>
                         
                         <td><select name="stuid">
                                 <%
                             while(rs.next())
                             {
                              %>
                                 <option class="form-control"  value="<%=rs.getInt("stuid")%>"><%=rs.getString("fname") %></option>
                              <%
                             } %>
                             </select></td>
                            </tr>
                            <tr>
                                <td>Days Present</td>
                                <td><input class="form-control" type="text" name="dp" ></td>
                            </tr>
                            <tr>
                                <td>Days Absent</td>
                                <td><input class="form-control" type="text"  name="da"></td>
                            </tr>
                            <tr>
                                <td>Total Fees</td>
                                <td><input class="form-control" type="text" name="tf" id="tfe"></td>
                            </tr>
                            <tr>
                                <td>Paid Fees</td>
                                <td><input class="form-control" type="text" name="paf" id="pafe" onchange="getfees(this)"></td>
                            </tr>
                            <tr>
                                <td>Pending Fees</td>
                                <td><input class="form-control" type="text" name="pef" id="pefe"></td>
                            </tr>
                            <tr>
                                <td><input type="submit" class="form-control" value="Enter"></td>
                                </tr>
                     </table></center>
             </form>

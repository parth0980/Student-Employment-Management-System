...
%><form>
    ...
    { %>
        <tr>
            ...
            <td><%=rs.getInt("abs_days") %></td>
            <td><%=rs.getInt("totalfees") %></td>
            <td><%=rs.getInt("paidfees") %></td>
            <td><%=rs.getString("pendingfees") %></td>
                   </tr>
         <%          
}
                                 %>
